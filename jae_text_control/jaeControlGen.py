                ...
                if v["Category"] != "Deprecated":
                        ...
                        if feat in ["fun", "get", "set"]:
                                if checkTypes(name, v):
                                        ...
                                        if stringResult:
                                                returnType = "wxCharBuffer"
                                        if returnType == "void":
                                                out.append("\t" + returnType + " " + normalisedName(name, options, feat) + "(" + arguments(v, stringResult, options)+ ")" + constDeclarator + ";")
                                        else:
                                                out.append("\t" + "auto " + normalisedName(name, options, feat) + "(" + arguments(v, stringResult, options)+ ")" + constDeclarator + " -> " + returnType + ";")
                ...
                if v["Category"] != "Deprecated":
                        ...
                        if feat in ["fun", "get", "set"]:
                                if checkTypes(name, v):
                                        ...
                                        if returnType == "void":
                                                out.append(returnType + " jaeTextEditControl::" + normalisedName(name, options, feat) + "(" +
                                                arguments(v, stringResult, options) +
                                                ")" + constDeclarator + " {")
                                        else:
                                                out.append("auto " + " jaeTextEditControl::" + normalisedName(name, options, feat) + "(" +
                                                arguments(v, stringResult, options) +
                                                ")" + constDeclarator + " -> " + returnType + " {")
...
def main(argv):
        ...
        try:
                GenerateFile("jaeTextEditControl.cpp.template", "jaeTextEditControl.cpp",
                        "/* ", True, printCPPFile(f, options))
                GenerateFile("jaeTextEditControl.h.template", "jaeTextEditControl.h",
        ...
        if cleanGenerated:
                for file in ["jaeTextEditControl.cpp", "jaeTextEditControl.h"]:
                        try:
                                os.remove(file)
                        except OSError:
                                pass
